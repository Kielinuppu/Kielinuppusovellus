...
export default function HakemistoPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        // Hae ensin aiheet ja niiden id:t
        ...
        const fetchedLaulut = laulutSnapshot.docs
          .map(doc => ({
            id: doc.id,
            ...doc.data()
          })) as Laulu[]
        
        // Järjestä laulut aakkosjärjestykseen
        ...
        // Hae kuvat jokaiselle laululle
        for (const laulu of sortedLaulut) {
          try {
  ...
  // Suodata laulut hakutermin perusteella
